...
it('String', () => {
    ...
    //Verificar se contem 'de'
    expect(str).to.contains('de');
    //Verificar se existe
    expect(str).to.match(/de/);
    //Verificar de inicia com..
    expect(str).to.match(/^String/);
    //Verifica se termina com..
    expect(str).to.match(/teste$/);
    //Verficar o tanhanho e recebe qualquer caractere
    expect(str).to.match(/.{15}/);
    //Verififcar se existe apenas letras
    expect(str).to.match(/\w+/);
    //Verificar se não tem numeros 
